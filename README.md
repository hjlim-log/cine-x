...
### 할인 시스템
- **쿠폰** — 정액 할인 / 정률 할인 / 무료 티켓 3가지 타입, 코드 입력 발급
- **제휴할인** — 신용카드 5종 (신한 / 현대 / KB국민 / 삼성 / 롯데)
- **중복 적용** — 쿠폰 먼저 → 제휴할인 (쿠폰 적용 후 금액 기준), `combinableWithCoupon` 플래그로 제어
- **요금 정책** — 상영관 유형·관람객 유형·평일/주말·2D/3D 조합의 매트릭스 요금
